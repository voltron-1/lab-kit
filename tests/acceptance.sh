...
out="$("$LAB" status 2>&1)"
assert_contains "status shows all 9 ps P4 labs passed (9/50)" "$out" "(9/50)"
...
out="$("$LAB" status 2>&1)"
assert_contains "status shows all 16 ps P4+P5 labs passed (16/50)" "$out" "(16/50)"
...
out="$("$LAB" status 2>&1)"
assert_contains "status shows all 21 ps P4+P5+P6 labs passed (21/50)" "$out" "(21/50)"
