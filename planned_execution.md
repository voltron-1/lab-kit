...
## NEXT UP
Track: **ps p4 — PowerShell as Attack Surface** is **fully closed out** (9/9 labs, `tests/acceptance.sh` P4 section, tag `ps-p4`). Next unstarted item: **ps p5 — Deobfuscation & Malware Reading** (7 labs); no build plan drafted yet.
