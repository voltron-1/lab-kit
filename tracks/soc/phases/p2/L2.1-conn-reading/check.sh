#!/usr/bin/env bash
set -euo pipefail
: "${LAB_WORKSPACE:?run this via: lab check soc L2.1}"
: "${LAB_CHECKLIB:?run this via: lab check soc L2.1}"
# shellcheck source=/dev/null
source "$LAB_CHECKLIB"

# --- BEGIN GENERATED KEY (genevidence: s2-conn-reading) ---
KEY_Q1_B64="Y3JkMDAwMDY="
KEY_Q2_B64="c2Y="
KEY_Q3_B64="c3Ns"
KEY_Q4_B64="MTIwMw=="
KEY_Q5_B64="MjAzLjAuMTEzWy5dNjY="
KEY_Q6_B64="Mg=="
# --- END GENERATED KEY ---
...
assert_file_exists "conn-state-legend.md"
