...
1. Inspect `files/reported.eml`, `files/sandbox-report.md`, and `files/report-template.md`.
   `files/model-report.md` is a worked example of a DIFFERENT reported email — check it if you want to calibrate what "good" looks like beyond what `lab check` grades (structure, ATT&CK ID, verdict, and defanging).
